...
static void SDL_FrameDraw(SDL_Widget *Widget,SDL_Surface *surface,SDL_Rect *Area)
{
    ...
    if(Frame->TitleLeft)
    {
        ...
        SDL_ImageBlitToSurface(Frame->TitleLeft,NULL,surface,&dst);
    ...
    if(Frame->TitleRight)
    {
        ...
        SDL_ImageBlitToSurface(Frame->TitleRight,NULL,surface,&dst);
    }
    ...
    if(Frame->TitleCenter)
    {
        ...
        SDL_ImageBlitToSurface(Frame->TitleCenter,NULL,surface,&dst);
    ...
    if(Frame->Left)
    {
        ...
        SDL_ImageBlitToSurface(Frame->Left,NULL,surface,&dst);
    ...
    if(Frame->Right)
    {
        ...
        SDL_ImageBlitToSurface(Frame->Right,NULL,surface,&dst);
    }
    ...
    if(Frame->BottomLeft)
    {
        ...
        SDL_ImageBlitToSurface(Frame->BottomLeft,NULL,surface,&dst);
    }
    ...
    if(Frame->BottomRight)
    {
        ...
        SDL_ImageBlitToSurface(Frame->BottomRight,NULL,surface,&dst);
    }
    ...
    if(Frame->Bottom)
    {
        ...
        SDL_ImageBlitToSurface(Frame->Bottom,NULL,surface,&dst);
    }
}
