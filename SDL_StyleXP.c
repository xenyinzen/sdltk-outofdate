...
int SDL_StyleXPInit()
{
    ...
    SDL_StyleSetDrawFunction(SDL_StyleXP,"SDL_HorizontalScrollbar",SDL_StyleXPPaintScrollbar);
    SDL_StyleSetDrawFunction(SDL_StyleXP,"SDL_VerticalScrollbar"  ,SDL_StyleXPPaintScrollbar);
    return 1;
}
