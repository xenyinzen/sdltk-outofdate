...
void SDL_SliderDraw(SDL_Widget *widget,SDL_Surface *surface,SDL_Rect *Area)
{
    ...
    if(Slider->SliderBar)
    {
        SDL_ImageBlitToSurface(Slider->SliderBar,surface,&widget->Rect);
    }
    ...
    else
    {
        ...
        if(Slider->state && Slider->SliderButtonPressed)
            SDL_ImageBlitToSurface(Slider->SliderButtonPressed,surface,&button);
        else
            SDL_ImageBlitToSurface(Slider->SliderButton,surface,&button);
    }
