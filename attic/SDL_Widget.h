...
typedef int  (*T_Widget_StyleSetImage)(SDL_Style *style,int state,SDL_Image *image);
typedef void (*T_Widget_StyleSizeInfo)(int control,int state,SDL_Rect  *size,SDL_StyleImage *styleimage);
