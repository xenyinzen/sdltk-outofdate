...
static int  SDL_RadioButtonStyleSetImage(SDL_Style *style,int state,SDL_Image *image);
...
static void SDL_RadioButtonStyleDraw(SDL_Widget *widget,SDL_Surface *surface,SDL_Rect *Area,SDL_StyleImage *s)
{
    ...
    SDL_ImageBlitToSurface(RadioButtonImage,surface,&r);
}
...
static int  SDL_RadioButtonStyleSetImage(SDL_Style *style,int state,SDL_Image *image)
{
    ...
    SDL_StyleWidget *widget = SDL_StyleWidgetEntry(style,"SDL_RadioButton");
